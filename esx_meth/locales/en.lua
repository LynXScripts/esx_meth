Locales ['en'] = {
  -- meth
  ['meth_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~meth~s~ plant.',
  ['meth_quitprocess'] = 'press ~INPUT_CONTEXT~ to stop ~g~Process meth~s~.',
  ...
  ['meth_processingstarted'] = 'processing ~g~meth~s~ into ~g~packaged_meth~s~...',
  ['meth_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['meth_processingenough'] = 'you must have ~b~3x~s~ ~g~meth~s~ in order to process.',
  ['meth_processed'] = 'you\'ve processed ~b~3x~s~ ~g~meth~s~ to ~b~1x~s~ ~g~packaged_meth~s~',
